...
return [
    'admin' => [
        'system' => [
            ...
            'enable_categories_home_page_listing' => 'فعال کردن لیست دسته‌ها در صفحه اصلی',
            ...
            'module-info' => [
                ...
                'desc'        => 'اطلاعات مربوط به نسخه اپلیکیشن را ارائه می‌دهد.',
                'title'       => 'اطلاعات ماژول',
            ],
        ...
        'layouts' => [
            ...
            'title'             => 'طرح PWA',
            'update-success'    => 'طرح PWA با موفقیت به‌روزرسانی شد',
        ],
        ...
        'push-notification' => [
            ...
            'create-success'       => 'اعلان فشار با موفقیت به‌روزرسانی شد.',
        ...
        'notification' => [
            'delete-success' => 'اعلان فشار با موفقیت حذف شد.',
            'update-success' => 'اعلان فشار با موفقیت به‌روزرسانی شد.',
        ],
    ],
