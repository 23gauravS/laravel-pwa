...
return [
    'admin' => [
        'system' => [
            ...
            'auth-domain'                         => 'සත්‍යාපන ක්ෂේත්‍රය',
            'background-color'                    => 'පසුබැසුණු වර්ණය',
            'btn-save'                            => 'සුරකින්න',
            'database-url'                        => 'දත්ත සමුදා URL',
            'enable_categories_home_page_listing' => 'ප්‍රධාන පිටුවේ වර්ග ලැයිස්තුව සක්‍රීය කරන්න',
            'enable_featured'                     => 'විශේෂිත නිෂ්පාදන සක්‍රීය කරන්න',
            'enable_new'                          => 'නව නිෂ්පාදන සක්‍රීය කරන්න',
            'enable_slider'                       => 'ස්ලයිඩර් සක්‍රීය කරන්න',
            ...
            'status'                              => 'තත්ත්වය',
            'system-info'                         => 'PWA වින්‍යාසය',
            'theme-color'                         => 'තේමාව වර්ණය',
            'topic'                               => 'මාතෘකාව',

            'module-info' => [
                'app-version' => 'යෙදුම් අනුවාදය: v2.1.x',
            ...
            'seo' => [
                ...
                'title'            => 'ප්‍රධාන පිටුව SEO',
            ],
        ],

        'layouts' => [
            'push-notification' => 'පුෂ් දැනුම්දීම්',
            'sub-title'         => 'ප්‍රධාන පිටුව අන්තර්ගතය',
    ...
    'shop' => [
        'home' => [
            'enable-pwa-status' => 'අවවාදය: PWA දීර්ඝතාවය තත්ත්වය සක්‍රීය කරන්න.',
        ],
    ],
];